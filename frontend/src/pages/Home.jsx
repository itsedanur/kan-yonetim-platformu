...
const Home = () => {
  ...
  return (
    <div className="home-container" style={{ 
      ...
      {/* ROW 2: CARDS SECTION */}
      <div style={{ background: 'white', borderRadius: '24px', padding: '2rem 3rem', display: 'flex', flexDirection: 'column', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9', flex: 1, minHeight: 0 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem', flex: 1, alignItems: 'center' }}>
          {helpSteps.map((step, i) => (
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '0.5rem 1rem' }}>
              <div style={{ background: step.bg, width: '56px', height: '56px', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem', boxShadow: '0 4px 10px rgba(0,0,0,0.02)' }}>
