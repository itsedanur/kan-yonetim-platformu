                  ...
                  {app.requesterName && (
                    <div style={{ textAlign: 'right' }}>
                      <button
                        ...
                        style={{ background: '#f8fafc', color: '#0f172a', border: '1px solid #e2e8f0', padding: '0.6rem 1rem', borderRadius: '10px', fontSize: '0.85rem', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.4rem', transition: 'all 0.2s' }}
                      >
